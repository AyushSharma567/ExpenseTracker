...
const AddTransaction = ({ onTransactionAdded }) => {
    ...
    return (
        <div className="bg-white p-6 lg:p-8 rounded-lg shadow-md mb-8 transform transition-all duration-200 hover:shadow-lg">
            <h2 className="text-xl lg:text-2xl font-bold mb-6 text-gray-800">Add New Transaction</h2>
